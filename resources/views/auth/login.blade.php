<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <!-- Main Card -->
        <div class="max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-xl shadow-lg border-2 border-orange-500 relative z-10">
            <!-- Pumpkin Decoration -->
            ...
            <div class="text-center">
                <!-- Cauldron Icon -->
                <div class="mx-auto h-12 w-12 text-orange-500 hover:animate-bounce">
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-orange-500 font-creepster tracking-wide">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required
                               class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
